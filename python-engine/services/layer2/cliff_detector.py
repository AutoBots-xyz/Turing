...
from schemas.layer2 import HeatmapPoint, ZoneFinderInput, ZoneFinderOutput, UnexploredZone, SearchSpace, GaussianPrediction
    ...
    def find_zones(self, payload: ZoneFinderInput) -> ZoneFinderOutput:
        ...
        for node in source_nodes:
            ...
            for gap_min, gap_max in unexplored_gaps:
                ...
                # ERR-B42 fix: Do not inject synthetic Gaussian Predictions
